...
const imageUrl = 'https://s7ap1.scene7.com/is/image/hdfcbankPWS/tata-neu-p?wid=1000&hei=625&fmt=png-alpha';
const tempPath = path.join(__dirname, 'tata_neu_p_high_res.png');
const croppedPath = path.join(__dirname, 'tata_neu_p_cropped.png');
