...
const tempPath = path.join(__dirname, 'doctor_temp.png');
const targetPath = path.join(__dirname, '..', 'public', 'images', 'doctors-sbi.webp');
...
async function main() {
  try {
    ...
    console.log('Processing Doctor card image...');
