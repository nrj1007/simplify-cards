...
const tempPath = path.join(__dirname, 'apollo_temp.png');
const targetPath = path.join(__dirname, '..', 'public', 'images', 'apollo-sbi-select.webp');
...
async function main() {
  try {
    ...
    console.log('Processing Apollo image...');
