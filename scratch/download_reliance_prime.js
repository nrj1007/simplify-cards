...
const imageUrl = 'https://www.sbicard.com/static-resources/img/card-face/front/vertical/reliance-prime-card-face-min.png';
const tempPath = path.join(__dirname, 'reliance_prime_temp.png');
const targetPath = path.join(__dirname, '..', 'public', 'images', 'reliance-sbi-prime.webp');
