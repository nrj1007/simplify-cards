...
function groupCardsBy(values, card, index) {
    ...
    for (const value of values) {
        const existing = (_a = index.get(value)) !== null && _a !== void 0 ? _a : [];
        existing.push(card);
...
function searchableTextForCard(card) {
    ...
    return [
        ...
        ...card.tags,
        ...card.exclusions,
        ...((_a = card.milestoneBenefits) !== null && _a !== void 0 ? _a : []),
        ...((_b = card.additionalBenefits) !== null && _b !== void 0 ? _b : []),
        ...((_c = card.additionalDetails) !== null && _c !== void 0 ? _c : []),
        ...((_d = card.internalNotes) !== null && _d !== void 0 ? _d : [])
    ]
        .join(" ")
        .toLowerCase();
}
...
function getCardsByIssuer(issuer) {
    var _a;
    return (_a = exports.cardIndexes.byIssuer[issuer]) !== null && _a !== void 0 ? _a : [];
}
function getCardsByTag(tag) {
    var _a;
    return (_a = exports.cardIndexes.byTag[tag]) !== null && _a !== void 0 ? _a : [];
}
function getCardsByNetwork(network) {
    var _a;
    return (_a = exports.cardIndexes.byNetwork[network]) !== null && _a !== void 0 ? _a : [];
}
function getCardsByRewardCategory(category) {
    var _a;
    return (_a = exports.cardIndexes.byRewardCategory[category]) !== null && _a !== void 0 ? _a : [];
}
function getCardsByPopularityBand(band) {
    var _a;
    return (_a = exports.cardIndexes.byPopularityBand[band]) !== null && _a !== void 0 ? _a : [];
}
function getCardsByUseCase(bucket) {
    var _a;
    return (_a = exports.cardIndexes.byUseCase[bucket]) !== null && _a !== void 0 ? _a : [];
}
function getCardsByRedemptionBucket(bucket) {
    var _a;
    return (_a = exports.cardIndexes.byRedemptionBucket[bucket]) !== null && _a !== void 0 ? _a : [];
}
function getCardsByCardSegment(segment) {
    var _a;
    return (_a = exports.cardIndexes.byCardSegment[segment]) !== null && _a !== void 0 ? _a : [];
}
