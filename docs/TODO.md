...
- [ ] Check comparison queries in the Ask AI flow to see if we can redirect comparison queries (e.g., "A vs B") directly to the compare page.
...
- [x] Verify the ranking golden test snapshot (`tests/ranking-golden.test.ts`) to ensure card ordering is correct for each of the following scenarios:
  ...
  - [x] "usecase-dining" (query: "best dining card")
  - [x] "usecase-grocery" (query: "best grocery card")
  - [x] "usecase-online" (query: "best online shopping card")
  - [x] "usecase-entertainment" (query: "best card for movies")
  - [x] "usecase-fuel" (query: "best card for fuel")
  - [x] "usecase-travel" (query: "best travel card")
  - [x] "usecase-cashback" (query: "best cashback card")
  - [x] "usecase-upi" (query: "best upi card")
  - [x] "merchant-amazon" (query: "best amazon card")
  - [x] "merchant-flipkart" (query: "best flipkart card")
  - [x] "merchant-swiggy" (query: "best swiggy card")
  - [x] "category-rent" (query: "best rent card")
  - [x] "category-rent-payment" (query: "best card for rent payment")
  - [x] "category-utilities" (query: "best utility card")
  - [x] "category-utility-bills" (query: "best card for utility bills")
  - [x] "category-bill-payments" (query: "best card for bill payments")
  - [x] "category-education-payments" (query: "best card for education payments")
  - [x] "issuer-hdfc" (query: "best hdfc card")
  - [x] "issuer-sbi" (query: "best sbi card")
  - [x] "issuer-axis" (query: "best axis card")
  - [x] "issuer-icici" (query: "best icici card")
  - [x] "issuer-amex" (query: "best amex card")
  - [x] "segment-beginner" (query: "best beginner card")
  - [x] "segment-mid-premium" (query: "best mid premium card")
  - [x] "segment-premium" (query: "best premium card")
  - [x] "segment-super-premium" (query: "best super premium card")
  - [x] "network-rupay" (query: "best rupay card")
  - [x] "network-visa" (query: "best visa card")
  - [x] "network-mastercard" (query: "best mastercard credit card")
  - [x] "forex" (query: "best forex card")
  - [x] "lounge" (wantsLounge: true)
  - [x] "lounge-query" (query: "best lounge card")
  - [x] "intl-lounge-query" (query: "best international lounge card")
  - [x] "lifetime-free" (wantsLifetimeFree: true)
  - [x] "max-fee-zero" (maxAnnualFee: 0)
  - [x] "max-fee-5000-query" (query: "best card under 5000")
  - [x] "combo-premium-travel" (query: "best premium travel card")
  - [x] "combo-dining-under-5000" (query: "best dining card under 5000")
  - [x] "spend-international" (query: "best card for international spends")
  - [x] "spend-fuel-heavy" (heavy fuel spend profile)
  - [x] "spend-travel-heavy" (heavy travel spend profile)
  - [x] "spend-high-base" (high base spend profile)
  - [x] "spend-level-light" (balanced light spend profile)
  - [x] "spend-level-mid" (balanced mid spend profile)
  - [x] "spend-level-heavy" (balanced heavy spend profile)
...
- [ ] Add a reward calculator / yield estimator to the card comparison page (/compare) to show side-by-side calculated yields.
