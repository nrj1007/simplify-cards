...
const curatedScores = new Map([
  ...
  ["axis-magnus", 85],
  ["axis-magnus-burgundy", 79],
  ["icici-sapphiro", 85],
  ["indusind-eazydiner", 84],
  ["indusind-tiger", 83],
  ["sc-ultimate", 83],
  ...
  ["onecard", 82],
  ["sc-smart", 82],
  ["sc-super-value-titanium", 81],
  ["sc-rewards", 80],
  ["indusind-platinum-rupay", 80],
  ["icici-times-black", 84],
  ["equitas-ultima", 73],
  ["idfc-wow", 84],
  ...
  ["indusind-eazydiner-platinum", 79],
  ["sc-easemytrip", 79],
  ["sc-digismart", 79],
  ["icici-sapphiro-rupay", 80],
  ["icici-coral-rupay", 77],
  ["sc-manhattan-platinum", 78],
  ["federal-celesta", 75],
  ["icici-hpcl-coral", 74],
  ["kotak-white-reserve", 76],
  ["kotak-solitaire", 75],
  ["kotak-infinite", 72],
  ["kotak-pvr-gold", 69],
  ["indusind-pioneer-legacy", 73],
  ["indusind-crest", 71],
  ["indusind-pioneer-heritage-metal", 75],
  ["rbl-world-prime", 74],
  ["sc-platinum-rewards", 76],
  ["sc-priority-visa-infinite", 74],
  ["sc-beyond", 72],
  ["federal-imperio", 72],
  ["equitas-tiger", 71],
  ["federal-wave", 71],
  ...
  ["kotak-upi-rupay", 78],
  ["rbl-play", 77],
  ["kotak-cashback-plus", 77],
  ["indusind-aura-edge", 77],
  ["axis-select", 78],
  ["tata-neu-infinity-sbi", 78],
  ["icici-platinum-chip", 78],
  ["flipkart-sbi", 77],
  ["kotak-indianoil", 77],
  ["rbl-platinum-maxima-plus", 76],
  ["kotak-league-platinum", 76],
  ["indusind-celesta", 76],
  ["kotak-zen-signature", 75],
  ["rbl-icon", 75],
  ["rbl-cookies", 74],
  ["kotak-white", 74],
  ["indusind-nexxt", 74],
  ["rbl-platinum-delight", 73],
  ["rbl-patanjali-swarn", 73],
  ["icici-rubyx", 77],
  ...
  ["rbl-world-max", 72],
  ["kotak-811", 72],
  ["rbl-patanjali-vishisht", 71],
  ["kotak-811-dream-different", 71],
  ["kotak-pvr-platinum", 70],
